...
public class Parser {
    ...
    private Statement declaration(){
        try{
            ...
            return statement();
        }catch( ParseError pe){ synchronize(); return null; }
    }
    ...
    private Statement varDeclaration(){
        ...
        if( previous().getType() != TokenType.SEMICOLON ) consume( TokenType.SEMICOLON , "Pritet ';' pas deklarimit te variables !" );
    ...
    private Expression primary() {
        ...
        if( match(TokenType.NUMBER , TokenType.TEXT) ) { return new Expression.Literal( previous().getLiteral() ); }
    ...
    //-----------------------------------------------------------------------------------------------------------
    private boolean isAtFileEnd(){ return peek().getType() == TokenType.EOF; }
