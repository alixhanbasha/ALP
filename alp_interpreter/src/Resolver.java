...
public class Resolver implements Statement.Visitor<Void>, Expression.Visitor<Void> {
    ...
    public void resolve( List<Statement> statements ){ for( Statement s: statements ){ resolve( s ); } }
    public void resolveObjects( List<Object> obj ){ for( Object s: obj ){ resolve( (Statement)s ); } } // for elseif
    private void resolve( Statement s ){ s.accept(this); }
    private void resolve( Expression e ){ e.accept(this); }
    ...
    @Override
    public Void visitPrintStatement( Statement.Print s ){ resolve( s.expr ); return null;}
    @Override
    public Void visitImportStatement( Statement.Import s ){ resolve( s.expr ); return null; }
    @Override
    ...
    @Override
    public Void visitBinaryExpression( Expression.Binary e ){ resolve( e.left ); resolve( e.right ); return null; }
    @Override
    public Void visitUnaryExpression( Expression.Unary e ){ resolve( e.right ); return null; }
    @Override
    public Void visitLogicalExpression( Expression.Logical e ){ resolve( e.left ); resolve( e.right ); return null; }
    @Override
    public Void visitLiteralExpression( Expression.Literal e ){ return null; }
    @Override
    ...
    @Override
    public Void visitGroupingExpression( Expression.Grouping e ){ resolve(e.expr); return null; }
    @Override
