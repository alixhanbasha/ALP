...
class ALP {
    ...
    public static void printHelp(){ System.out.println("Me jep opcione te sakta !"); }
    public static void printUsage(){ System.out.println( "This is the usage" ) ; }
	...
	public static void run( String source ){
      try {
        ...
        npe.printStackTrace();
        runtimeError( new RuntimeError( new Token() , "\033[0;31mU shkaktua nje error fatal.\033[0m") ); System.exit( 1 );
      }
  }
  // ---------------------------------------------------------------------------------------------
    ...
    private static boolean isImported( String module ){
        ...
        for( String s : importedModules ){
            if( s.equals( module ) ) { is_imported = true; break; }
        }
        return is_imported;
    }
            ...
            case "--time":
              ...
              case "--PS1":
                  try{
                      ...
                      ALP.PROMPT = args[i+1];
                      i++;
                  }catch(Exception e){ System.out.println("Could not set the prompt"); }
                  break;
