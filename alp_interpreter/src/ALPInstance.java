...
public class ALPInstance {
    ...
    public ALPInstance( ALPClass c ){ this.klasa = c; } // kostruktor
    ...
    public String getInstanceName(){ return this.klasa.getClassName(); }

    @Override
    public String toString(){ return "<Instance => '" + klasa.getClassName() + "'>"; }
}
