...
public class Environment {
	...
	public Environment(Environment enc) {
		enclosing = enc;
	}

	public void define(String name, Object value) {
		if (values.get(name) != null) {
			ALP.error(new Token(), "\033[0;32mVaraiabla '" + name + "' vetem eshte e definuar.\033[0m");
			return;
		}
	...
	public HashMap<String, Object> getVariableTable() {
		return this.values;
	}

	public void setVariableTable(HashMap<String, Object> values2) {
		this.values = values2;
	}
}
